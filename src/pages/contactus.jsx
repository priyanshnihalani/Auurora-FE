                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                                <div className="text-center lg:text-left">
                                    <h2 className="text-3xl font-bold mb-2 text-black">Need a faster answer?</h2>
                                    <p className="text-slate-800">Check out our detailed documentation and FAQ pages.</p>
                                </div>
                                <div className="flex gap-4">
                                    <a className="px-8 py-3.5 rounded-xl border-2 border-white font-bold hover:bg-white/10 transition-all text-black" href="#">Browse Docs</a>
                                    <a className="px-8 py-3.5 rounded-xl border-2 border-white font-bold hover:bg-white/10 transition-all text-black" href="#">Visit FAQ</a>
                                </div>
                            </div>
                        </div>
                    </section>
